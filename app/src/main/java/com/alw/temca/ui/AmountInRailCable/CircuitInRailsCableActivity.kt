...
import kotlinx.android.synthetic.main.activity_circuit_in_rails_cable.*


class CircuitInRailsCableActivity : AppCompatActivity() {
    companion object{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_circuit_in_rails_cable)
        ...
        if(RowAmountAmpMain != 99) {
            if(RowAmountAmpMain == 7){
                cardViewCircuitBreaker.setOnClickListener {
                    intent = Intent(this, CircuitBreakerInRailsCableActivity::class.java)
