...
//        val groupOfMain = intent.getStringExtra("Group").toString()
        ...
        typeCableItem.add(TypeCableModel("PVC แกนเดี่ยว"))
        typeCableItem.add(TypeCableModel("PVC หลายแกน"))
        typeCableItem.add(TypeCableModel("XLPE แกนเดี่ยว"))
        typeCableItem.add(TypeCableModel("XLPE หลายแกน"))
