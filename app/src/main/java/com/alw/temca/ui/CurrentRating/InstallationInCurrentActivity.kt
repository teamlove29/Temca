...
import com.alw.temca.Adapter.AdapterCurrentRating.InstallationCurrentAdapter
import com.alw.temca.Interfaces.onClickInAdapter
import com.alw.temca.Model.OnePhase.InstallationModel
import com.alw.temca.R
import kotlinx.android.synthetic.main.activity_installation_current.*

class InstallationInCurrentActivity : AppCompatActivity(), onClickInAdapter {
    private val installItem = ArrayList<InstallationModel>()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_installation_current)
        ...
        recyclerViewInstallation.adapter = InstallationCurrentAdapter(installItem,this)
