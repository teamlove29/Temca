...
import kotlinx.android.synthetic.main.activity_circuit_breaker_in_three_phase.*


class CircuitBreakerInThreePhaseActivity : AppCompatActivity(), onClickInAdapter {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_circuit_breaker_in_three_phase)
