...
class TypeCableOnePhase(var TypeCableList : ArrayList<TypeCableModel>, var onClickTypeCable: onClickInAdapter): RecyclerView.Adapter<TypeCableOnePhase.TypecableViewHolder>() {
