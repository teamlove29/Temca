...
class InstallationThreePhaseAdapter(private var InstallList: ArrayList<InstallationModel>, private var onClickInstall: onClickInAdapter)
    : RecyclerView.Adapter<InstallationThreePhaseAdapter.InstallViewHolder>() {
