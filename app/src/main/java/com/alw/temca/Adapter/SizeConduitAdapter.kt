...
class SizeConduitAdapter(var listSizeConduit : ArrayList<SizeConduitModel>, var onClickTypeCable:InstallationonClickAdapterListener) : RecyclerView.Adapter<SizeConduitAdapter.SizeViewHolder>(){
    class SizeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {

        fun bind(itemList: SizeConduitModel, action: InstallationonClickAdapterListener){
