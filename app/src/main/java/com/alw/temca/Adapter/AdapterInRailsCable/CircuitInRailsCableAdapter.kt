...
class CircuitInRailsCableAdapter(var listCircuit : ArrayList<CircuitModel>, var onClick : onClickInAdapter) : RecyclerView.Adapter<CircuitInRailsCableAdapter.CircuitViewHolder>() {
