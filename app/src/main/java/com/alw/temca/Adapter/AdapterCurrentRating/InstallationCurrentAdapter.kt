...
class InstallationCurrentAdapter(private var InstallList: ArrayList<InstallationModel>, private var onClickInstall: onClickInAdapter)
    : RecyclerView.Adapter<InstallationCurrentAdapter.InstallViewHolder>() {
