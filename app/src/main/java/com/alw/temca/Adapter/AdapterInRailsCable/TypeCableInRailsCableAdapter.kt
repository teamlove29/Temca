...
class TypeCableInRailsCableAdapter(var TypeCableList : ArrayList<TypeCableModel>, var onClickTypeCable:onClickInAdapter): RecyclerView.Adapter<TypeCableInRailsCableAdapter.TypecableViewHolder>() {
