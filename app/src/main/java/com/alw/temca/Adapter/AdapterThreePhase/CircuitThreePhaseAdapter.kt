...
class CircuitThreePhaseAdapter(var listCircuit : ArrayList<CircuitModel>, var onClick : onClickInAdapter) : RecyclerView.Adapter<CircuitThreePhaseAdapter.CircuitViewHolder>() {
