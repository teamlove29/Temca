...
class TypeCableAdapter(var TypeCableList : ArrayList<TypeCableModel>, var onClickTypeCable: onClickInAdapter) : RecyclerView.Adapter<TypeCableAdapter.TypecableViewHolder>() {
