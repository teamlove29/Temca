...
class TypeCableCurrentAdapter(var TypeCableList : ArrayList<TypeCableModel>, var onClickTypeCable: onClickInAdapter): RecyclerView.Adapter<TypeCableCurrentAdapter.TypecableViewHolder>() {
